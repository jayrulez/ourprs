...
void FormController::SetFormMenuController(MenuController *MenuControllerObj)
{
    this->MenuControllerObj=MenuControllerObj;
}
int FormController::BrowseForm()
{
    ...
    while(!read)
    {
        ...
        switch(TextInputObj.GetVirtualKey())
        {
            ...
            break;
            case F1_KEY:
                ExtendedMenuCalls(F1_KEY,FormCode);
            break;
            case F3_KEY:
                ExtendedMenuCalls(F3_KEY,FormCode);
            break;
        }
        UpdateField();
...
int FormController::ExtendedMenuCalls(int Key,int CurrentCode)
{
